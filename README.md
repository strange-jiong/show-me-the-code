...
- 感谢原文，由@史江歌（shijiangge@gmail.com  QQ:499065469）根据互联网资料收集整理而成，感谢互联网，感谢各位的分享。鸣谢！本文会不断更新。
- 0025题之后的由本人继续整理
...
**第 0026 题：**使用Python实现：学校翱翔门户验证码的识别,[西北工业大学翱翔门户](http://cas.nwpu.edu.cn/cas/login?service=http%3A%2F%2Fportal.nwpu.edu.cn%2Fdcp%2Findex.jsp),识别其中的验证码图片。

参考思路：

1：获取尽量多的验证码图片，至少也来个几十张吧

2：利用机器学习的方法，推荐SVM支持向量机

- [阅读资料：实验楼python识别验证码]()

**第0027题：**使用Python实现，获取计算机磁盘剩余空间的大小。
